...
post_handler = function(payload) {
    ...
    message_string = "["+repo + "/" + payload['branch'] + "] <"+ payload['vcs_url'] + "/commit/" + payload['vcs_revision'] +"|"+payload['vcs_url'].substring(0,12)+">: " + payload['status'].toUpperCase() + " " + payload['subject'] + " - " + payload['author_name']
