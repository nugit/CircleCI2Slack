...
post_handler = function(payload) {
    ...
    message_string = repo + "/" + payload['branch'] + ": " + payload['subject'] + " by " + payload['author_name'] + " " + payload['status'].toUpperCase() + " <"+ payload['vcs_url'] + "/commit/" + payload['vcs_revision'] +"|"+payload['vcs_url'].substring(0,12)+">"
